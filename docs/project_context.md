...
3.  **Sửa lỗi định tuyến của nút hành động trong thông báo**:
    *   Nhập tệp [app_constants.dart](file:///c:/Users/Admin/IdeaProjects/football_booking/frontend/lib/core/constants/app_constants.dart) vào [notifications_screen.dart](file:///c:/Users/Admin/IdeaProjects/football_booking/frontend/lib/features/notification/screens/notifications_screen.dart).
    *   Bổ sung trường `fieldId` vào thực thể [Notification.java](file:///c:/Users/Admin/IdeaProjects/football_booking/backend/src/main/java/vn/footballfield/entity/Notification.java) và cập nhật [BookingReminderScheduler.java](file:///c:/Users/Admin/IdeaProjects/football_booking/backend/src/main/java/vn/footballfield/infrastructure/scheduler/BookingReminderScheduler.java) để lưu ID của sân bóng vào các thông báo yêu cầu đánh giá `REVIEW_REQUEST`.
    *   Thêm phương thức `getFieldById` trong [field_repository.dart](file:///c:/Users/Admin/IdeaProjects/football_booking/frontend/lib/features/field/repositories/field_repository.dart).
    *   Cập nhật nút "Đánh giá ngay" trong [notifications_screen.dart](file:///c:/Users/Admin/IdeaProjects/football_booking/frontend/lib/features/notification/screens/notifications_screen.dart) để tự động tải thông tin sân bóng theo `fieldId` và định tuyến trực tiếp người dùng tới màn hình đánh giá của sân bóng tương ứng (`AppConstants.addRating`).
    *   Định tuyến nút "Xem lịch đặt" tới Tab lịch sử đặt sân (`AppConstants.bookingHistory`) qua `Navigator.pushNamedAndRemoveUntil(context, AppConstants.bookingHistory, (route) => false)` để tránh crash do gọi pop() không hợp lệ.
4.  **Loại bỏ biểu tượng cảm xúc (emojis) trong các thông báo SnackBar**:
...
8.  **Cấu hình deploy riêng tư**:
    *   Đã tạo thư mục `my_deploy/` chứa tệp hướng dẫn [my_deploy.md](file:///c:/Users/Admin/IdeaProjects/football_booking/my_deploy/my_deploy.md), script deploy 1-click [deploy.ps1](file:///c:/Users/Admin/IdeaProjects/football_booking/my_deploy/deploy.ps1), script đồng bộ DB [sync_db.ps1](file:///c:/Users/Admin/IdeaProjects/football_booking/my_deploy/sync_db.ps1), và script tự động đóng gói ứng dụng di động [build_apk.ps1](file:///c:/Users/Admin/IdeaProjects/football_booking/my_deploy/build_apk.ps1) để tối ưu hóa quy trình cập nhật.
