  ...
  Future<void> _loadConversations() async {
    ...
    try {
      ...
      if (widget.userType == "USER") {
        await chatProvider.loadConversationsForUser(widget.userId);
      } else {
        await chatProvider.loadConversationsForOwner(widget.userId);
      }
      
      if (mounted) {
        setState(() {
          conversations = chatProvider.conversations.map((json) => Conversation.fromJson(json)).toList();
          isLoading = false;
        });
      }
    } catch (e) {
